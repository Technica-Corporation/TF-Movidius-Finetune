...
def main(_):
    ...
    with open('{}/commandline_args.txt'.format(FLAGS.train_dir), 'w') as f:
        f.write('\n'.join(sys.argv[1:]))
    with tf.Graph().as_default():
        ...
        # Select the dataset #
        ######################
        dataset = get_split('train', FLAGS.dataset_dir, FLAGS.num_classes, file_pattern=FLAGS.file_pattern, file_pattern_for_counting=FLAGS.file_pattern_for_counting)
