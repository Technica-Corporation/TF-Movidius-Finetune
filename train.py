...
def main(_):
    ...
    with tf.Graph().as_default() as graph:
        ...
        image, label = load_batch(dataset, FLAGS.preprocessing, FLAGS.batch_size, train_image_size, FLAGS.num_readers)
        ...
        sv = tf.train.Supervisor(logdir = FLAGS.train_dir, summary_op = None, init_fn=_get_init_fn())
